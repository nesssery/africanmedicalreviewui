...
class AuthController extends GetxController {
  ...
  Future<void> registerUser({
    ...
    final String apiUrl =
        "https://api.africanmedicalreview.com/users/api/signup/";
  ...
  Future<void> loginUser(
    ...
    isLoading.value = true;
    final String apiUrl =
        "https://api.africanmedicalreview.com/users/api/login/";
  ...
  Future<void> subscribeUser() async {
    isLoading.value = true;
    final String apiUrl =
        "https://api.africanmedicalreview.com/users/api/subscribe/";
  ...
  Future<void> updateUserInfo(
    ...
    isLoading.value = true;
    final String apiUrl =
        "https://api.africanmedicalreview.com/users/api/update/";
